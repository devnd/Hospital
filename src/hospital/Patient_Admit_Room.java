...
PreparedStatement pst=null;
    ...
    private void initComponents() {
        ...
        cmbRoomNo.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "O+", "O-", "A+", "A-", "B+", "B-", "AB+", "AB-" }));
                                    ...
                                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                        ...
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            ...
                                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                                .addComponent(cmbRoomNo, javax.swing.GroupLayout.Alignment.LEADING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jPanel1Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {txtDisease, txtPatientID, txtPatientName});
        ...
        PTbl.setFont(new java.awt.Font("Playfair Display", 0, 18)); // NOI18N
        ...
        DTbl.setFont(new java.awt.Font("Playfair Display", 0, 18)); // NOI18N
    ...
    try{
        ...
        if(txtPatientName.getText().equals("")){
            JOptionPane.showMessageDialog(this,"Please enther the Patient Name","Error",JOptionPane.ERROR_MESSAGE);
        }
        
        if(cmbGender.getSelectedItem().equals("-1")){
            JOptionPane.showMessageDialog(this,"Please select the Enter","Error",JOptionPane.ERROR_MESSAGE);
        }
